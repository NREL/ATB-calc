...
from lcoe_calculator.config import YEARS, END_YEAR, FINANCIAL_CASES, CrpChoiceType, PTC_PLUS_ITC_CASE_PVB
                ...
                if Tech.has_tax_credit and fin_case == 'Market':
                    ...
                    if Tech.sheet_name == "Utility-Scale PV-Plus-Battery":
                        if proc.tax_credit_case is PTC_PLUS_ITC_CASE_PVB and year > 2022:
                            ...
                            input_vals["ITC"] = df_itc.loc[name][year] * batt_occ_percent.loc[Tech.default_tech_detail + '/Moderate'][year]
                        else:
                            input_vals["PTC"] = 0
